...
async def create_user(db: Connection, user_id):
    sql = """
...
async def create_super_user(db: Connection, user_id, is_superuser=True):
    sql = """
...
async def stopped_by_user(db: Connection, user_id):
    sql = """
